      ...
      <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
          <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Event Edit Form</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-xl-4 mb-4">
        ...
        <?php }?>
          ...
          <input name="event_link" type="text" class="form-control" id="event_link" aria-describedby="event_link" value="<?php // $event['event_link'] ?>" required> -->
          <?php if($event['event_mode'] == 0) {?>
      ...
      <legend style="margin-left: 0%; width: 47%;" class="h6">Paid Promotion</legend>
        ...
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          ...
          <input name="event_price" type="number" min="0" step="1" class="form-control" id="event_price" aria-describedby="event_price" value="<?= $event['event_price'] ?>" onkeyup="checkDiscountType()" required>
        </div>
        ...
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          ...
          <input name="discount_price" type="number" min="0" step="1" class="form-control" id="discount_price" aria-describedby="discount_price" value="<?= $event['discount_price'] ?>" onkeyup="checkDiscountType()" required>
        </div>
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
