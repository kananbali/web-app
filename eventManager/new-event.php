...
<body>
  ...
  <main class="content">
    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-xl-4 mb-4">
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          ...
          <input name="event_name" type="text" class="form-control" id="event_name" aria-describedby="event_name" required>
        </div>
        ...
        <label class="my-1 me-2" for="event_category">Event Category</label>
          ...
          <div style="margin-left: 0%; width: 97%;" class="mb-3">
            ...
            <input name="event_date" class="form-control" id="event_date" type="date" placeholder="dd/mm/yyyy" required>
          </div>

          <div style="margin-left: 0%; width: 97%;" class="mb-4">
            <label for="event_seats">Number of Seats</label>
            <input name="event_seats" type="number" min="0" class="form-control" id="event_seats" aria-describedby="event_seats" required>
          </div>

          <form id="imgupload">
          <div style="margin-left: 0%; width: 97%;" class="mb-3">
            <label for="formFile" class="form-label">Event Image</label>
            <input name="image_path" class="form-control" type="file" id="event_image" required>
          </div>
        </form>
      ...
      <div class="col-12 col-sm-6 col-xl-4 mb-4">
        ...
        <legend style="margin-left: 0%; width: 47%;" class="h6">Event Mode</legend>
          <div style="margin-left: 0%; width: 47%;" class="form-check form-switch">
            <input class="form-check-input" type="checkbox" id="eventmodetoggle">
            <input hidden name="event_mode" id="hiddeneventmodetoggle">

            <label class="form-check-label" for="flexSwitchCheckDefault" id="eventmodelabel"></label>
          </div>

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_venue" id="event_venue_label">Event Platform</label>
          <input name="event_venue" type="text" class="form-control" id="event_venue" aria-describedby="event_venue" required>
        </div>

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_link" id="event_link_label">Event Link</label>
          <input name="event_link" type="text" class="form-control" id="event_link" aria-describedby="event_link" required>
        </div>

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_start_time">Start Time</label>
          <input name="event_start_time" type="time" class="form-control" id="event_start_time" aria-describedby="event_start_time" required>
        </div>

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_end_time">End Time</label>
          <input name="event_end_time" type="time" class="form-control" id="event_end_time" aria-describedby="event_end_time" required>
        </div>

        

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_cancellation_time">Cancel Before time</label>
          <!-- <input type="text" placeholder="6,12,24" class="form-control" id="event_cancellation_time" aria-describedby="event cancellation time" required> -->
      ...
      <div class="col-12 col-sm-6 col-xl-4 mb-4">
        ...
        <div style="margin-left: 0%; width: 47%;" class="form-check form-switch">
          <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" value="0">
          <input hidden name="paid_promotion" id="hiddenflexSwitchCheckDefault" value="0">
          <label class="form-check-label" for="flexSwitchCheckDefault" id="toggle-label"></label>
        </div>

        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="event_price">Ticket Price</label>
          <input name="event_price" type="number" min="0" step="1" class="form-control" id="event_price" aria-describedby="event_price" onkeyup="checkDiscountType()" required>
        </div>
        ...
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          ...
          <select name="discount_type" class="form-control" id="discount_type" aria-describedby="discount_type" onchange="checkDiscountType()" required>
            ...
            <option value="0">Flat Offer</option>
            <option value="1">Percentage Offer</option>
          </select>
        </div>
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="discount_price">Discount Price</label>
          <input name="discount_price" type="number" min="0" step="1" class="form-control" id="discount_price" aria-describedby="discount_price" onkeyup="checkDiscountType()" required>
        </div>
        <input name="discounted_price" type="hidden" min="0" step="1" class="form-control" id="discounted_price" aria-describedby="discounted_price" required>
        
        <div style="margin-left: 0%; width: 97%;" class="mb-4">
          <label for="selling_price">Selling Price</label>
          <input id="selling_price" class="form-control" type="text" placeholder="" readonly>
        </div>


        <div style="margin-left: 0%; width: 97%;" class="my-4">
            <label for="textarea">Event Description</label>
            <textarea maxlength="255" name="textarea" class="form-control" placeholder="Other Details..." id="textarea" rows="5" required></textarea>
          </div>
      </div>
    </div>
    <div style="margin-left: 0%;" class="mb-4">
      ...
      <div class="card">
        <?php require_once './editorjs_editor.php'; ?>
      </div>
    </div>
    ...
    $("#subbutton").click(function() {
      ...
      setTimeout(function() {
        ...
        data: {
          ...
          manager_id: '<?= $manager ?>',
          extended_event_description: localStorage.getItem('event_desc'),
          ...
          if (data['status'] == 1) {
            Swal.fire({
              ...
              Email.send({
                  ...
                  Subject: "New Event Added Successful",
                  Body: 'Thank you for adding a New Event. You will receive status of the event acceptance shortly.<br>Here are your event details<br>Event Name:' + $("#event_name").val() + '<br>Event Date: ' + $("#event_date").val() + '<br>Event Price: ' + $("#event_price").val() + '<br>Discounted Price: ' + $("#discounted_price").val() + '<br>Event Seats: ' + $("#event_seats").val() + '<br>Event Venue: ' + $("#event_venue").val(),
                })
                .then(function() {
